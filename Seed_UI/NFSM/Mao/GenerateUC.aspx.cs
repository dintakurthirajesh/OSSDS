...
public partial class NFSM_MAO_MAOHome : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/nfsm/MAO/M_UC_Generation.aspx");
    }
    protected void GenerateUCDtls()
    {
        try
        {
           ...
           nfsmobj.uid = Session["uc_uid"].ToString();
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/nfsm/Reports/Rpt_Mao_Uc_Gen.rdlc");
