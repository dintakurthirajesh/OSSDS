<%@ Page Language="C#" AutoEventWireup="true" CodeFile="M_UC_Generation.aspx.cs"
...
<head runat="server">
    <meta charset="utf-8" />
    <title>Utilization Certificate(UC)</title>
            ...
            <div class="">
                ...
                <div class="col-md-10" id="card" style="margin-top: 0">
                    <div class="card-header">
                        <span class="card-title">Utilization Certificate(UC) Generate </span>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                  ...
                                  <%--  <div class="row">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 ">
                                                    <asp:DropDownList ID="ddlscheme" runat="server" CssClass="form-control" AutoPostBack="True"
                                    ...
                                    onselectedindexchanged="ddlsubcheme_SelectedIndexChanged"></asp:DropDownList>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:DropDownList ID="ddlCroptype" runat="server" CssClass="form-control" AutoPostBack="True"
                                                        OnSelectedIndexChanged="ddlCroptype_SelectedIndexChanged">
                                                        <asp:ListItem Value="">-- Select --</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-md-2 t-center">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:DropDownList ID="ddlintervenstion" runat="server" CssClass="form-control" AutoPostBack="True"
                        ...
                        <div class="form-group">
                            ...
                            <!--Popup Box- start-->
                            <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Style="z-index: 111; background-color: White;
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10" id="Div1" style="margin-top: 0">
                                            <div class="card-header">
                                                <span class="card-title">Update Challan Details</span>
                                            </div>
                                            <br />
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-6  text-right">
                                                        <label for="txtchallanamt">
                                                            Challan Amount</label>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:TextBox ID="txtchallanamt" runat="server" MaxLength="10" placeholder="Enter Challan/DD Amount"
                                                            CssClass="form-control"  onkeypress="return isSpec(event);"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <br />
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:TextBox ID="txtDatePicker" runat="server" placeholder="Enter Challan/DD Date"
                                                            CssClass="form-control"  onkeypress="return isSpec(event);"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <br />
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 align-left">
                                                        <asp:Button runat="server" ID="btnclose" Text="Close" OnClick="btnclose_Click" class="btn btn-danger"
                         ...
                         <%--   <asp:Panel ID="pnlgridview" runat="server" BackColor="White" Style="z-index: 111;
                            ...
                            <div class="col-md-12 table-responsive">
                                <asp:GridView ID="gvschmefiling" CssClass="table table-bordered table-hover table-striped fnt"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Update Challan Details">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="linkupdate" Text="Update" CommandName="ShowPopup"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="View Doculemts">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="linkView" Text="View" OnClick="linkview_OnClick"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Utilization Certificate(UC)">
                                            <ItemTemplate>
