...
public partial class CropMaster : System.Web.UI.Page
{
    ...
    protected void BindCaste()
    {
        ...
        objCommon.BindDropDownLists(ddlcategory, dt, "CasteName", "CasteCode", "Select Caste");
    ...
    protected void bindgridview()
    {
        ...
        nfsmobj.Flag = "R";
        dt = obj.NFSM_ItemWiseCrop_subsidyDetails(nfsmobj, Session["constr"].ToString());
        if (dt.Rows.Count > 0)
        {
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            nfsmobj.gendercd = rblGander.SelectedValue.Trim();
            nfsmobj.Percentage = txtPercentage.Text;
    ...
    protected void linklinkedit_OnClick(object sender, EventArgs e)
    {
        ...
        Label lblGender = (Label) gv.FindControl("lblGender");
        Label lblPercentage = (Label) gv.FindControl("lblPercentage");
        ...
        if (lblGender.Text == "F")
        {
            rblGander.SelectedValue = "F";
        }
        else
            rblGander.SelectedValue = "M";
