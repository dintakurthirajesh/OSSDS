<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MST_FIRM_MFG.aspx.cs" Inherits="NFSM_Admin_AgencyMaster" %>
                    ...
                    <div class="col-md-10" id="card" style="margin-top: 0">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2  text-right">
                                ...
                                <div class="col-md-3">
                                                                <asp:DropDownList runat="server" ID="ddlAgency"  CssClass="form-control" AutoPostBack="true"
                                    required="required" onselectedindexchanged="ddlAgency_SelectedIndexChanged" ></asp:DropDownList>
                            
                                </div>
                            </div>
                               <div class="form-group">
                                 <div class="col-md-3  text-right">
                            <label for="txtschemename">Firm Name</label>
                            </div>
                            <div class="col-md-3"><asp:TextBox ID="txtfirmname" runat="server" MaxLength="10" placeholder="Enter Firm Name" required="required" CssClass="form-control" onkeypress="return isSpec(event);"></asp:TextBox></div>
                              <div class="col-md-2  text-right">
                            ...
                            <div class="col-md-3  text-right">
                             ...
                             <div class="col-md-2  text-right">
                            <label for="txtschemename">Phone No</label>
                            </div>
                            <div class="col-md-3"><asp:TextBox ID="txtPhoneNo" runat="server" MaxLength="10" placeholder="Enter Phone No" required="required" CssClass="form-control" onkeypress="return isSpec(event);"></asp:TextBox></div>
                            </div>
                              <div class="form-group">
                             <div class="col-md-3  text-right">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-2  text-right">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtifsccode" runat="server" MaxLength="120" placeholder="Enter IFSC Code"  CssClass="form-control" onkeypress="return isSpec(event);"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                             <div class="col-md-3  text-right">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtAccountNumber" runat="server" MaxLength="10" placeholder="Enter Account Number"  CssClass="form-control" onkeypress="return isSpec(event);"></asp:TextBox>
                                </div>
                                  ...
                                  <asp:GridView ID="gvitemsubsidy" CssClass="table table-bordered table-hover table-striped fnt"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Fin Year" Visible="false" >
                                          ...
                                          <asp:TemplateField HeaderText="Firm Code">
                                            <ItemTemplate>
                                                 <asp:Label runat="server" ID="lblagency_code" Text='<%#Eval("agency_code") %>' Visible="false"></asp:Label>
                                                  <asp:Label runat="server" ID="lblFirm_code" Text='<%#Eval("Firm_code") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Agency Name" >
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblagency_name" Text='<%#Eval("agency_name") %>'></asp:Label>
                                             
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Firm Name" >
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblfirmname" Text='<%#Eval("Firm_name") %>'></asp:Label>
                                     ...
                                     <asp:TemplateField HeaderText="Bank Name" >
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblbank_code" Text='<%#Eval("bank_code") %>' Visible="false"></asp:Label>
