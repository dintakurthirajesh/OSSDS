<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CropMaster.aspx.cs" Inherits="CropMaster" %>
   ...
   <div class="row">
                    ...
                    <div class="col-md-10" id="card" style="margin-top: 0">
                        ...
                        <div class="card-header">
                            <span class="card-title">Intervention </span>
                </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                           <%-- <div class="col-md-3  text-right">
                            ...
                            <div class="col-md-3 text-right">
                                    <label for="txtcropname" >Intervention Name</label>
                                </div>
                                <div class="col-md-3 text-left">
                                <asp:Label runat="server" ID="lblcropcode" Visible="false"></asp:Label>
                                    <asp:TextBox ID="txtcropname" runat="server" MaxLength="120" placeholder="Enter Crop Name" CssClass="form-control" required="required" onkeypress="return isSpec(event);"></asp:TextBox>
                                </div>
                            </div>
                                  <%-- <div class="form-group">
                            ...
                            <div class="col-md-12 table-responsive">
                                  <asp:GridView ID="gvitemsubsidy" CssClass="table table-bordered table-hover table-striped fnt"
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Intervention Code" >
                                            <ItemTemplate>
