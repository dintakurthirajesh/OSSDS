<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstAgency.aspx.cs" Inherits="SchemeMaster" %>
   ...
   <div class="row"><div class="form-group"></div>
                    ...
                    <div class="col-md-10" id="card" style="margin-top: 0">
                        ...
                        <div class="card-header text-center">
                            <span class="card-title text-center"><h1>Agency </h1></span>
                        </div>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sl.No">
                                          ...
                                          <asp:TemplateField HeaderText="Agency Code">
                                            <ItemTemplate>
                                                 <asp:Label runat="server" ID="lblAgencyCode" Text='<%#Eval("agency_code") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
