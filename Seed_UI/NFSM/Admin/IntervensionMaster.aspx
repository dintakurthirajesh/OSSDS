<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntervensionMaster.aspx.cs" Inherits="CropMaster" %>
...
<head runat="server">
    <meta charset="utf-8" />
    <title>Intervension Master</title>
   ...
   <div class="row">
                    ...
                    <div class="col-md-10" id="card" style="margin-top: 0">
                        ...
                        <div class="card-header">
                            <span class="card-title">&nbsp;Sub Intervention </span>
                </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" ID="ddlschemename"  CssClass="form-control" 
                            ...
                            <asp:DropDownList runat="server" ID="ddlsubcheme"  CssClass="form-control" 
                              ...
                              <div class="col-md-3 text-right">
                                ...
                                <div class="col-md-3 text-left">
                                  <asp:DropDownList runat="server" ID="ddlcropname"  CssClass="form-control" 
                                        required="required" AutoPostBack="True" 
                                        onselectedindexchanged="ddlcropname_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                                 <div class="col-md-2  text-right">
                                    <label for="txtintervension" >Sub Intervention  Name</label>
                                </div>
                                <div class="col-md-3 text-left">
                                 <asp:Label runat="server" ID="lblintervensioncd" Visible="false"></asp:Label>
                                    <asp:TextBox ID="txtintervension" runat="server" MaxLength="120" placeholder="Enter Sub Intervention Name" CssClass="form-control" required="required" onkeypress="return isSpec(event);"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 table-responsive">
                                  <asp:GridView ID="gvitemsubsidy" CssClass="table table-bordered table-hover table-striped fnt"
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Intervention Code" Visible="false">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Sub Intervention Code" >
                                            <ItemTemplate>
                                                 <asp:Label runat="server" ID="lblinetervencode" Text='<%#Eval("subinterven_code") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Sub Intervention Name" >
                                            <ItemTemplate>
