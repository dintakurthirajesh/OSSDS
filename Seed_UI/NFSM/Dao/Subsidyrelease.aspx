<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subsidyrelease.aspx.cs"
...
<head runat="server">
    <meta charset="utf-8" />
    <title>Utilization Certificate(DAO)</title>
            ...
            <div class="">
                ...
                <div class="col-md-12" id="card" style="margin-top: 0">
                    <div class="card-header">
                        <span class="card-title">Subsidy Release </span>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                           ...
                           Sub Scheme Name
                            ...
                            <asp:DropDownList runat="server" ID="ddlsubcheme"  CssClass="form-control"                            
                                   AutoPostBack="True" onselectedindexchanged="ddlsubcheme_SelectedIndexChanged"></asp:DropDownList></ContentTemplate></asp:UpdatePanel>
                            </div>
                                    </div>
                                </div>
                                <div class="form-group">
                  ...
                  <%--    <div class="form-group">
                        <div class="col-md-12  text-left">
                            <span class="card-title"><span style="color: Red;">Subsidy Details</span></span></div>
                    </div>
                     <div class="form-group">
                        <div class="col-md-3 text-center">
                            <label for="txtbankaccount">
                        ...
                        <div class="col-md-3 text-left">
                            <asp:TextBox ID="TextBox1" runat="server" MaxLength="18" placeholder="Enter Account No"
                                 CssClass="form-control" onkeypress="return isSpec(event);"></asp:TextBox>
                        </div>
                        <div class="col-md-3 text-center">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 table-responsive">
                                <asp:GridView ID="gvschmefiling" CssClass="table table-bordered table-hover table-striped fnt" ShowFooter="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Crop type" Visible="false">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Full Cost"  Visible="false">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Challan No">
                                            ...
                                            <FooterTemplate>
                                            <asp:Label ID="lblrefno" Text="RTGS/UTI No" runat="server"></asp:Label>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Challan Amount" Visible="false">
                                            <ItemTemplate>
                                       ...
                                       <asp:TemplateField HeaderText="RTGS/UTI No.">
                                            <ItemTemplate>
                                                  <asp:TextBox runat="server" ID="txtrefno" placeholder="Enter RTGS/UTI No."  CssClass="form-control"></asp:TextBox>     
                                            </ItemTemplate>
                                            <FooterTemplate>
                                            <asp:TextBox runat="server" ID="txtfrefno" placeholder="Enter RTGS/UTI No."  CssClass="form-control"></asp:TextBox>  
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Amount">
                                            <ItemTemplate>
                                                  <asp:TextBox runat="server" ID="txtamount" placeholder="Enter Amount" Text='<%#Eval("subsidy_amt") %>' Enabled="false"  CssClass="form-control"></asp:TextBox>     
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Date">
                                            <ItemTemplate>
                                                  <asp:TextBox runat="server" ID="txtrefdate" placeholder="Enter Bank Ref. Date"  CssClass="form-control"></asp:TextBox>     
                                            </ItemTemplate>
                                             <FooterTemplate>
                                            <asp:TextBox runat="server" ID="txtfrefdate" placeholder="Enter Bank Ref. Date"  CssClass="form-control"></asp:TextBox>  
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="View Doculemts" Visible="false">
                                            <ItemTemplate>
                                               <%-- <asp:LinkButton runat="server" ID="linkView" Text="View" OnClick="linkview_OnClick"></asp:LinkButton>--%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Utilization Certificate(MAO)" Visible="false">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="linkfarmerid"  Text='<%#Eval("uc_no") %>' OnClick="linkfarmerid_OnClick"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Generate(UC)" Visible="false">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="linkso" Text="Utilization Certificate(DAO)" OnClick="linkso_OnClick"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Subsidy Release Status">
                                            <ItemTemplate>
