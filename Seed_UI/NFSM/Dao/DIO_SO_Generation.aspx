<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIO_SO_Generation.aspx.cs"
            ...
            <div class="">
                ...
                <div class="col-md-10" id="card" style="margin-top: 0">
                    <div class="card-header">
                        <span class="card-title">Utilization Certificate(DAO) Generate </span>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-md-12 align-center">
                                                      ...
                                                      <asp:ModalPopupExtender ID="mp1" runat="server" PopupControlID="Panel2" CancelControlID="btnLogClose"
        TargetControlID="HiddenField1" BackgroundCssClass="modalBackground"></asp:ModalPopupExtender>
        ...
        <table width="800px" style="overflow: auto; background-color: white;">
            <tr>
                <td align="right" class="header">
                    <asp:ImageButton ID="btnLogClose" runat="server" ImageUrl="~/NFSM/images/close.jpg" Width="40px"
                                ...
                                <asp:GridView ID="gvschmefiling" CssClass="table table-bordered table-hover table-striped fnt"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Utilization Certificate(MAO)">
                                          ...
                                          <asp:TemplateField HeaderText="Generate(UC)">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="linkso" Text="Utilization Certificate(ADO)" OnClick="linkso_OnClick"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
