...
public partial class NFSM_MAO_MAOHome : System.Web.UI.Page
{
    ...
    {
       // Response.Redirect("~/nfsm/DAO/DIO_SO_Generation.aspx");
        Response.Redirect("~/nfsm/DAO/DaoApprove_Schemes.aspx");
    ...
    protected void getSupplyOrderGeneration()
    {
        try
        {
           ...
           nfsmobj.Flag = "DAO";
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/nfsm/Reports/Rpt_Proceedingorder.rdlc");
            lgdistrict dsdistrict = new lgdistrict();
            dsdistrict.Tables.Add(dt);
            ReportDataSource datasource = new ReportDataSource("DataSet2", dsdistrict.Tables[1]);
