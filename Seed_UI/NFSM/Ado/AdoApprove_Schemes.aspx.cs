...
public partial class NFSM_MAO_SchemeFilingSearch : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            DataTable dt = new DataTable();
            dt = obj.Update_Status_Schemefiling(dtforward, "ADO", Session["constr"].ToString());
            if (dt.Rows.Count > 0)
            {
                objCommon.ShowAlertMessage("Selected Schemes Forwarded to DAO ");
                loadgridview();
            }
        }
        }
