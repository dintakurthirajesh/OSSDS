<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdoGenerateUC.aspx.cs" Inherits="NFSM_MAO_MAOHome" %>
        ...
        <div class="container">
            ...
            <div class="col-md-10" id="card" style="margin-top: 0;">
                <div class="card-header">
                    <span class="card-title">Utilization Certificate Generate(ADO)</span>
                </div>
                <div class="form-group">
                </div>
