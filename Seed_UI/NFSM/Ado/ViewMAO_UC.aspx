<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewMAO_UC.aspx.cs" Inherits="NFSM_MAO_MAOHome" %>
...
<head id="Head1" runat="server">
    <meta charset="utf-8" />
    <title>Utilization Certificate(MAO)</title>
        ...
        <div class="container">
            ...
            <div class="col-md-10" id="card" style="margin-top: 0;">
                <div class="card-header">
                    <span class="card-title">Utilization Certificate View(MAO)</span>
                </div>
                <div class="form-group">
                </div>
