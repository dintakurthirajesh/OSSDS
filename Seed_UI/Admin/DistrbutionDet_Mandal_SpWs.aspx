<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DistrbutionDet_Mandal_SpWs.aspx.cs" Inherits="Admin_DistrbutionDetails" EnableEventValidation = "false" %>
                                    ...
                                    BorderWidth="1px" onrowcreated="gridviewdistrictwise_RowCreated" OnRowDataBound="gridviewdistrictwise_RowDataBound" 
                                              ...
                                              <asp:TemplateField ><ItemTemplate>
                                                <asp:Label runat="server" ID="sno" Text='<%# Container.DataItemIndex +1%>' /></ItemTemplate>
                                                  ...
                                                  <asp:TemplateField> 
                                                <ItemTemplate>  <asp:LinkButton runat="server" ID="linkmandalname" Enabled="false" Text='<%# bind("SalePtName") %>' Width="160px"/>
                                                <asp:Label runat="server" ID="lbldistrictcode" Text='<%# bind("DistCode") %>' Visible="false"/>
                                                <asp:Label runat="server" ID="lblmandal" Text='<%# bind("MandCode") %>' Visible="false"/>
                                                <asp:Label runat="server" ID="lblsalpointcode" Text='<%# bind("SalePtCode") %>' Visible="false"/>
                                                </ItemTemplate>
                                                 <FooterTemplate>
