...
public partial class Admin_DistrbutionDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
          ...
          //  BindCrops();
            ...
            lblremarks.Text = "District Name:" + Session["districtname"].ToString() + ",Mandal Name:" + Session["mandalname"].ToString() + ",Season:" + seasons.SelectedValue + ",Crop Name:" + ddlcrop.SelectedItem.Text + "";
    ...
    protected void gridviewdistrictwise_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header) // If header created
        {
            ...
            sldistrict.Text = "SalePoint Name";
    ...
    protected void GetReport()
    {
        ...
        {
            dt = new DataTable();
            dt = rprt.GetDistributionDet_Mandal_SpWs(ddlyear.SelectedValue, seasons.SelectedValue, ddlcrop.SelectedValue, Session["districtcd"].ToString(), Session["mandalcd"].ToString());
            if (dt.Rows.Count > 0)
            {
    ...
    protected void linknfsc_Click(object sender, EventArgs e)
    {
        ...
        {           
            ...
            Session["salepoint"] = null;
            Session["salepoint"] = ((Label)gvr.FindControl("lblsalpointcode")).Text;
