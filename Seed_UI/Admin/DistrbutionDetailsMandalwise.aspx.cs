...
public partial class Admin_DistrbutionDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
          ...
          //  BindCrops();
            ...
            lblremarks.Text = "District Name:" + Session["districtname"].ToString() + ",Season:" + seasons.SelectedValue + ",Crop Name:" + ddlcrop.SelectedItem.Text + "";
    ...
    protected void GetReport()
    {
        ...
        {
            dt = new DataTable();
            dt = rprt.GetDistributionDetailsmandalWs(ddlyear.SelectedValue, seasons.SelectedValue, ddlcrop.SelectedValue, Session["districtcd"].ToString());
            if (dt.Rows.Count > 0)
            {
    ...
    protected void linkmandal_Click(object sender, EventArgs e)
    {
        ...
        Session["mandalname"] = ((LinkButton)gvr.FindControl("linkmandalname")).Text;
        Session["districtcd"] = districtcd;
        Session["mandalcd"] = ((Label)gvr.FindControl("lblmandal")).Text;
        Response.Redirect("~/Admin/DistrbutionDet_Mandal_SpWs.aspx");
    }
    protected void linknfsc_Click(object sender, EventArgs e)
    {
        ...
        {           
            GridViewRow gvr = (GridViewRow)((LinkButton)sender).NamingContainer;
                ...
                Session["casttype"] = "sc";
                Session["gender"] = "";
                Session["mandalcd"] = null;
                Session["mandalname"] = null;
                Session["districtcd"] = ((Label)gvr.FindControl("lbldistrictcode")).Text;
                Session["mandalcd"] = ((Label)gvr.FindControl("lblmandal")).Text;
                Session["mandalname"] = ((LinkButton)gvr.FindControl("linkmandalname")).Text;
                Session["yearcd"] = ddlyear.SelectedValue;
                Session["season"] = seasons.SelectedValue;
                Session["crop"] = ddlcrop.SelectedValue;
                Response.Redirect("~/Admin/DistrbutionDetailsDrillFarmerMandalWs.aspx");    
    ...
    protected void linknfst_Click(object sender, EventArgs e)
    {
        ...
        {
            GridViewRow gvr = (GridViewRow)((LinkButton)sender).NamingContainer;
            string districtname = ((LinkButton)gvr.FindControl("linkmandalname")).Text;
    ...
    {
        Response.Redirect("~/admin/DistrbutionDetailsnew.aspx");
    }
}