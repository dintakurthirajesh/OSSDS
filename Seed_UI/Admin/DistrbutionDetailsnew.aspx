<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DistrbutionDetailsnew.aspx.cs" Inherits="Admin_DistrbutionDetails" EnableEventValidation = "false" %>
                                    ...
                                    BorderWidth="1px" onrowcreated="gridviewdistrictwise_RowCreated" OnRowDataBound="gridviewdistrictwise_RowDataBound" 
                                              ...
                                              <asp:TemplateField ><ItemTemplate>
                                                <asp:Label runat="server" ID="sno" Text='<%# Container.DataItemIndex +1%>' /></ItemTemplate>
                                                  ...
                                                  <asp:TemplateField> 
                                                <ItemTemplate>  <asp:LinkButton runat="server" ID="linkdistrictname" Text='<%# bind("DistName") %>' Width="160px" OnClick="linkdist_Click"/><asp:Label runat="server" ID="lbldistrictcode" Text='<%# bind("DistCode") %>' Visible="false"/></ItemTemplate>
                                                 <FooterTemplate>
