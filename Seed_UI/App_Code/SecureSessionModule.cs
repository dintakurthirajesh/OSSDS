...
public class SecureSessionModule : IHttpModule
{
    ...
    void OnBeginRequest (Object sender, EventArgs e)
    {
        ...
        if (cookie != null) {
            ...
            if (cookie.Value.Length <= 24)
                throw new InvalidSessionException ("Access denied"); // updated: don't want to give bad guy too much info
            ...
            string mac2 = GetSessionIDMac(id, request.ServerVariables["REMOTE_ADDR"], request.UserAgent, _ValidationKey);
    ...
    void OnEndRequest (Object sender, EventArgs e)
    {
        ...
        if (cookie != null) {
            // Add a MAC
            cookie.Value += GetSessionIDMac(cookie.Value,request.ServerVariables["REMOTE_ADDR"],
...
public class InvalidSessionException : Exception
{
    public InvalidSessionException () :
        base ("Access denied") {} // updated: don't want to give bad guy too much info
