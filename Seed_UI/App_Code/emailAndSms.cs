...
//-------------- this function is to check any mis match in SSL certificate
    ...
    {
        string username = "pashu.otp";
        string pin = "Ka%40%231234";
        string senderId = "TSGOVT";
        string createdURL = "";
        createdURL = "https://smsgw.sms.gov.in/failsafe/HttpLink?username=username=" + username + "&pin=" + pin + "&message=" + message + "&mnumber=91" + mobileNo.Trim() + "&signature=" + senderId;
        ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(AcceptAllCertifications);
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create(createdURL);
        request.Method = "POST";
