...
public class CommonFuncs
{
    ...
    public void BindListBox(ListBox list, DataTable ddt, string textfield, string valuefield, string strDefaultValue)
    {
        // if (ds.Tables.Count > 0)
        //{
        // if (ds.Tables[0].Rows.Count > 0)
        ...
        list.DataBind();
        list.Items.Insert(0, new ListItem(strDefaultValue, ""));
        ////ddl.SelectedIndex = 0;
        // }
    }
    public void BindDropDownLists_withZero(DropDownList ddl, DataTable ddt, string textfield, string valuefield, string strDefaultValue)
    {
        // if (ds.Tables.Count > 0)
        //{
        // if (ds.Tables[0].Rows.Count > 0)
        ...
        ddl.DataValueField = valuefield;
        ddl.DataBind();
        ddl.Items.Insert(0, new ListItem(strDefaultValue, "0"));
        ////ddl.SelectedIndex = 0;
        // }
    }
