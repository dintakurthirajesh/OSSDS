<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockTransfer.aspx.cs" Inherits="DAO_StockTransfer" %>
                            ...
                            <td align="center">
                                <table align="center" cellpadding="3" cellspacing="1" width="90%">
                                    ...
                                    <asp:ListItem Text="2020" Value="2020"></asp:ListItem>--%>
                                        ...
                                        <td align="left" class="style_td_label">
                                            <asp:DropDownList ID="ddlcrop" runat="server" Width="160px" AutoPostBack="True" 
                            ...
                            <td align="center">
                                <asp:GridView ID="StkGrid" runat="server" BackColor="#DEBA84" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="tomand" runat="server" Text="Transfer to Another Mandal" CommandArgument='<%# Eval("MandCode")+ "," +Eval("MandName")+ "," +Eval("crop")+ "," +Eval("stock_available")+ "," +Eval("bagsAvialble")+ "," +Eval("weight_of_bag") %>'
                                                    OnClick="Trnsfer_to_Mand"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="todist" runat="server" Text="Transfer to District" CommandArgument='<%# Eval("MandCode")+ "," +Eval("MandName")+ "," +Eval("crop")+ "," +Eval("stock_available")+ "," +Eval("bagsAvialble")+ "," +Eval("weight_of_bag") %>'
                                                    OnClick="Trnsfer_to_Dist"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
