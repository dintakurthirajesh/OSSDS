<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MandWiseDistribution.aspx.cs"
                        ...
                        <tr>
                            <td colspan="4" align="center" valign="top">
                                <table align="center" style="width: 800px; height: 260px;">
                                    <tr>
                                        <td align="center">
                                            <rsweb:ReportViewer ID="Rept" Width="100%" Height="100%" runat="server" SizeToReportContent="true" OnDrillthrough="Rept_Drillthrough">
                                            </rsweb:ReportViewer>
                                        </td>
                                    </tr>
                                </table>
