<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MandalAllSps.aspx.cs" Inherits="DAO_MandalAllSps" %>
        ...
        <table border="1" style="border: thick none #00CC00; background-color: white;">
            ...
            <tr>
                <th colspan="2" style="color: Red; background-color: #88d8e0; height: 35px;" class="style64">
                    &nbsp;All Sale Points in District</th>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td align="center" colspan="2">
                    <asp:GridView ID="gvsp" runat="server" BackColor="#DEBA84" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Mandal" DataField="MandName" HeaderStyle-HorizontalAlign="Center"
