...
public partial class MandalMaster : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                objCommon.BindDropDownLists(ddlestradistrict, ddt, "DistName", "DistCode_Lg", "0");
        ...
        try
        {
            ...
            else if (e.CommandName == "Edt")
            {
               ...
               // ddl_dist_code.SelectedValue = ((HiddenField)(gvrow.FindControl("hdndistcode"))).Value;
                ...
                if (((Label)(gvrow.FindControl("lblerastdidtCode"))).Text != "")
                {
                    try
                    {
                        ddlestradistrict.SelectedValue = ((Label)(gvrow.FindControl("lblerastdidtCode"))).Text;
                    }
                    catch { }
                }
    ...
    protected bool Validate()
    {
        ...
        if (ddlestradistrict.SelectedValue == "0")
        {
            objCommon.ShowAlertMessage("Select Erastwhile District");
            ddlestradistrict.Focus();
            return false; 
        }
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Validate())
            {
                ...
                objinsert.userid = UserName;
                if (ddlestradistrict.SelectedValue != "")
                {
                    objinsert.distname = ddlestradistrict.SelectedItem.Text;
                    objinsert.distlgcd = ddlestradistrict.SelectedValue;
                }
                else
                {
                    objinsert.distname = "";
                ...
                if (dt.Rows.Count > 0)
                {
                    if (dt.Columns[0].ColumnName == "succ")
                    {
                        ...
                        txtMandalName.Text = "";
                        txtMandallgCode.Text = "";
                        ddlestradistrict.SelectedValue = "";
                        //txtMandalLGCode.Text = "";
