<%@ Page Language="C#" AutoEventWireup="true" CodeFile="villageMaster_lg.aspx.cs" Inherits="MandalMaster" %>
                                ...
                                <td class="style65">
                                    <table class="tbldata" align="center" width="80%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtMandallgCode" runat="server" placeholder="Village LG Code" CssClass="style_txt_entry"
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtMandalName" runat="server" placeholder="Village Name" CssClass="style_txt_entry"
                                    ...
                                    <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" /></ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Mandal LG Code" Visible="false">
                                          ...
                                          <asp:TemplateField HeaderText="Village Code" >
                                            <ItemTemplate>
                                                <asp:Label ID="lblvillagecode" runat="server" Text='<%# Bind("Villcode") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
