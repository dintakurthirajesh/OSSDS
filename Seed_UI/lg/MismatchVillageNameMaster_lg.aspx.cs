...
public partial class MandalMaster : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                ddt.DefaultView.Sort = " DistName ASC";
                objCommon.BindDropDownLists(ddl_dist_code, ddt, "DistName", "DistCode", "District Name");
    ...
    protected void GvMandal_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "Dlt")
            {
                ...
                objinsert.villagecd = ((Label)(gvrow.FindControl("lblvillagecode"))).Text;
                objinsert.villagelgcd = ((Label)(gvrow.FindControl("lblvillagelgcode"))).Text;
                objinsert.villagename = lblvillagename.Text;              
                objinsert.userid = UserName;               
                objinsert.Flage = "D";
              

                dt = objDist.InsertVillage(objinsert);
          
                if (dt.Rows.Count > 0)
                {
                    objCommon.ShowAlertMessage(dt.Rows[0][0].ToString());
                
                    txtlocalvillagename.Text = "";
            ...
            else if (e.CommandName == "Edt")
            {
                ...
                if (ddl_dist_code.SelectedIndex > 0)
                {
                    ...
                    dt.DefaultView.Sort = " MandName ASC";
                ...
                lblvillagecode.Text = ((Label)(gvrow.FindControl("lblvillagecode"))).Text;
                txtlgvillagename.Text = ((Label)(gvrow.FindControl("lbllgvillagename"))).Text;
                lblvillagelgcode.Text = ((Label)(gvrow.FindControl("lbllocalvillagecode"))).Text;
                txtlocalvillagename.Text = ((Label)(gvrow.FindControl("lbllocalvillagename"))).Text;
    ...
    protected bool Validate()
    {
        ...
        if (txtlocalvillagename.Text == "")
        {
            objCommon.ShowAlertMessage("Enter Village Name");
            txtlocalvillagename.Focus();
            return false;
        }
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        try
        {
         ...
         //   if (Validate())
            ...
            //    //objinsert.villagelgcd = txtMandallgCode.Text.Trim();
            //    //objinsert.villagename = txtMandalName.Text.Trim();              
            //    //objinsert.userid = UserName;
    ...
    public void Viewdata()
    {
        try
        {
            ...
            if (ddl_mandal_code.SelectedValue != "")
            {
                objinsert.mandalcd = ddl_mandal_code.SelectedValue;
            }
            objinsert.Flage = Flag_IUP;

            dt1 = objDist.UpdateMismatchVillagewithLgName(objinsert);
            if (dt1.Rows.Count > 0)
            {
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lblvillagelgcode.Text = ((Label)(gRow.FindControl("lbllocalvillagecode"))).Text;
    ...
    protected void btn_Update_Click(object sender, EventArgs e)
    {
        try
        {
            if (Validate())
            {
                ...
                objinsert.distcd = ddl_dist_code.SelectedValue.ToString();
                objinsert.mandalcd = ddl_mandal_code.SelectedValue.Trim();
                objinsert.villagecd = lblvillagecode.Text;
                objinsert.villagelgcd = lblvillagelgcode.Text.Trim();
                objinsert.villagename = txtlocalvillagename.Text.Trim();            
                objinsert.userid = UserName;          
                objinsert.Flage = INSERT;

                dt = objDist.UpdateMismatchVillagewithLgName(objinsert);
