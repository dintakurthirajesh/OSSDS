<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MandalMaster_lg.aspx.cs" Inherits="MandalMaster" %>
                            ...
                            <tr align="center">
                                <td class="style65">
                                    <table class="tbldata" align="center" width="80%">
                                      ...
                                      <%--  <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtMandallgCode" runat="server" placeholder="Mandal LG Code" CssClass="style_txt_entry"
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtMandalName" runat="server" placeholder="Mandal Name" CssClass="style_txt_entry"
                                   ...
                                   <%--     <tr>
                                        ...
                                        <tr>
                                            <td align="right">
                                                Erastwhile District Name:</td>
                                            <td align="left">
                                                <asp:DropDownList ID="ddlestradistrict" runat="server" CssClass="style_txt_entry" AutoPostBack="true"
                                                    >
                                                      <%-- <asp:ListItem Text="Select Erastwhile District" Value="0"></asp:ListItem>  
                                                     <asp:ListItem Text="ADILABAD" Value="19"></asp:ListItem>
                                            
                                                   <asp:ListItem Text="Hyderabad" Value="16"></asp:ListItem>
                                                   <asp:ListItem Text="KARIMNAGAR" Value="20"></asp:ListItem>
                                                   <asp:ListItem Text="KHAMMAM" Value="22"></asp:ListItem>
                                                   <asp:ListItem Text="MAHABOORNAGAR" Value="14"></asp:ListItem>
                                                   <asp:ListItem Text="MEDAK" Value="17"></asp:ListItem>
                                                      <asp:ListItem Text="NALGONDA" Value="23"></asp:ListItem>
                                                         <asp:ListItem Text="NIZAMABAD" Value="18"></asp:ListItem>
                                                           <asp:ListItem Text="RANGA REDDY" Value="15"></asp:ListItem>
                                                            <asp:ListItem Text="WARANGAL" Value="21"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr align="center">
                                ...
                                <asp:GridView ID="GvMandal" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" /></ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Mandal Name">
                                           ...
                                           <asp:TemplateField HeaderText="Mandal Code (LG)">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMLGCode" runat="server" Text='<%# Bind("MandCode_LG") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="Sub District Code (LG)">
                                            <ItemTemplate>
                                                <asp:Label ID="lblsubdistCode" runat="server" Text='<%# Bind("sub_distcode") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="ErastWhile District Code (LG)">
                                            <ItemTemplate>
                                                <asp:Label ID="lblerastdidtCode" runat="server" Text='<%# Bind("erastwh_distcd") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="ErastWhile District Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblerastwhilenamee" runat="server" Text='<%# Bind("erastwh_distnm") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
