...
public partial class MandalMaster : System.Web.UI.Page
{
    ...
    public void Viewdata()
    {
        try
        {
            ...
            Flag_IUP = "R";
            dt1 = objDist.GetVillages(ddl_dist_code.SelectedValue.ToString(),ddl_mandal_code.SelectedValue.Trim(), Flag_IUP);
            if (dt1.Rows.Count > 0)
            {
                
                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/lg/lgvillageview.rdlc");
