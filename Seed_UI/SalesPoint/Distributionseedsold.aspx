<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Distributionseedsold.aspx.cs"
                        ...
                        <tr>
                            <td bgcolor="White" align="center" colspan="2">
                                <table width="90%">
                                    ...
                                    <tr>
                                        <td colspan="2" align="center">
                                            <asp:GridView ID="grdPermit" BackColor="#DEBA84" AutoGenerateColumns="false" BorderColor="#DEBA84"
                                                BorderStyle="None" BorderWidth="1px" PageSize="5" Width="80%" CssClass="Grid"
                                                runat="server" OnRowDataBound="grdPermit_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Price">
                                                        <ItemTemplate>
                                                            <asp:DropDownList ID="ddlprice" AutoPostBack="true" runat="server" Width="200px" CssClass="fldtxtbox">
                                                    ...
                                                    <asp:TemplateField HeaderText="No of bags Purchased " HeaderStyle-Width="100">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtPurchQty"  Width="50" runat="server"  AutoPostBack='<%# (bool)Eval("IsAuto")%>' 
