...
public partial class MAO_home : System.Web.UI.Page
{
    ...
    {
        dt = objAO.GetSeedAllotmentMandals(DateTime.Now.Year.ToString(), "Kharif", Session["distCode"].ToString(), Session["mandcode"].ToString());
        KharifGrid.DataSource = dt;
        KharifGrid.DataBind();

        dt = objAO.GetSeedAllotmentMandals(DateTime.Now.Year.ToString(), "Rabi", Session["distCode"].ToString(), Session["mandcode"].ToString());
