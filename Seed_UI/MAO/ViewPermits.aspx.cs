...
public partial class MAO_ViewPermits : System.Web.UI.Page
{
    ...
    protected void GetData(object sender, EventArgs e)
    {
        try
        {
            ...
            dt = rprt.GetPermits_DtWise(ddlsp.SelectedValue, frmdt, todt);
            if (dt.Rows.Count > 0)
            {
                Rept.Visible = true;
                ...
                // OR Set Report Path  
                Rept.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("~/RDLCReports/PermitsDtWs.rdlc");
