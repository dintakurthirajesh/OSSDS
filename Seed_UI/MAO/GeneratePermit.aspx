<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GeneratePermit.aspx.cs" Inherits="MAO_GeneratePermit" %>
                                        ...
                                        <td align="left">
                                            <b>
                                                <asp:Label ID="lblPextent" Style="font-weight: bold" runat="server"></asp:Label></b>
                                                 <label id="Label2" runat="server" style="font-weight: bold; color: #FF0000;">
                                                Acres/Cents</label>
                                        </td>
                                    </tr>
                                    <tr>
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Extent">
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <ajax:FilteredTextBoxExtender ID="ExtentExtender" runat="server" FilterType="Numbers,Custom"
                                                                                    TargetControlID="txtExtent" ValidChars=".">
                                                                        ...
                                                                        <asp:TemplateField HeaderText="No.of Bags Sanctioned">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txt_bags_sanctioned" Text='<%# Eval("Sanctioned") %>' runat="server"
                                                                                   ...
                                                                                   <ajax:FilteredTextBoxExtender ID="bagsExtender" runat="server" FilterType="Numbers"
                                                                                    TargetControlID="txt_bags_sanctioned" >
                                                                                </ajax:FilteredTextBoxExtender>
