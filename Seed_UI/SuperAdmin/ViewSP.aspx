<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewSP.aspx.cs" Inherits="SuperAdmin_ViewSP" %>
                    ...
                    <asp:GridView ID="gvsp" runat="server" BackColor="#DEBA84" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="District Name" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <asp:Label ID="lbldistcode" runat="server" Visible="false" Text='<%# Eval("DistCode")%>'></asp:Label>
                                    <asp:LinkButton ID="lblDist" runat="server" Text='<%# Eval("DistName")%>' OnClick="nosp_Click">LinkButton </asp:LinkButton>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="No.of SalePoints" FooterStyle-HorizontalAlign="Center"
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="nosp" runat="server" Text='<%# Eval("no_of_sp") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                ...
                                <FooterStyle HorizontalAlign="Center" BackColor="Silver"></FooterStyle>
