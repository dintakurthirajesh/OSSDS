...
public partial class SuperAdmin_MandalAllSps : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["UsrName"] == null || Session["UsrName"].ToString() != "ASuperAdmindmin")
        {
            Response.Redirect("~/Error.aspx");
        }
    ...
    {
        dt = rprt.GetAllSalePointsInDist(Session["dist"].ToString());
        gvsp.DataSource = dt;
        gvsp.DataBind();
    }
