<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MandWiseSP.aspx.cs" Inherits="SuperAdmin_MandWiseSP" %>
        ...
        <table border="1" style="border: thick none #00CC00; background-color: white;">
            ...
            <tr>
                <th colspan="2" style="color: Red; background-color: #88d8e0; height: 35px;" class="style64">
                    Mandal Wide Sale Points
                    <br />
                    District:
                    <asp:Label ID="lbldistNm" runat="server"></asp:Label>
                    Mandal:<asp:Label ID="lblMandNm" runat="server"></asp:Label>
                </th>
            </tr>
             <tr>
                <td colspan="2">
            ...
            <tr>
                <td align="center" colspan="2">
                    <asp:GridView ID="gvsp" runat="server" BackColor="#DEBA84" AutoGenerateColumns="false"
                        BorderColor="#DEBA84" Width="60%" BorderStyle="None" BorderWidth="1px" PageSize="10"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Sale Point Name" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <asp:Label ID="lblspnam" runat="server" Text='<%# Eval("SalePtName")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:BoundField HeaderText="Incharge" DataField="Incharge" />
                            <asp:BoundField HeaderText="Society Incharge " DataField="Incharge_Society" />
                            <asp:BoundField HeaderText="Incharge Mobile " DataField="mobile" />
                        </Columns>
