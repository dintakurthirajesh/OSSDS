<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MandalAllSps.aspx.cs" Inherits="SuperAdmin_MandalAllSps" %>
            ...
            <tr>
                <td align="center" colspan="2">
                    <asp:GridView ID="gvsp" runat="server" BackColor="#DEBA84" AutoGenerateColumns="false"
                        BorderColor="#DEBA84" Width="40%" BorderStyle="None" BorderWidth="1px" PageSize="10"
                        ...
                        <Columns>
                           ...
                           <%-- <asp:BoundField HeaderText="District" DataField="DistName" />--%>
                            <asp:BoundField HeaderText="Mandal" DataField="MandName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
